...
# cb_company_id=3 domain=www.h2o.ai
...
# # # #cb_company_id=1 domain=www.qounter.com/
...
# load_fc_company(fc_json_co_2, 'www.qounter.com/', 1)

# db.session.commit()

# load_fc_industry_types(fc_json_co_1)
# load_fc_company(fc_json_co_1, 'www.h2o.ai', 3)
